    ...
    <div className={styles.wrapper}>
      <div className={styles.contentWrapper}>
        ...
        <p className={styles.descriptionDesktop}>
          Genesis for Ukraine допомагає бізнесам екосистеми Genesis<br/>
          та партнерським компаніям зміцнювати обороноздатність України<br/>
          через гуманітарні ініціативи, втілювати спільні соціальні проєкти, <br/>
          а також підтримувати співробітників і їхніх рідних у війську.
        </p>
      </div>
